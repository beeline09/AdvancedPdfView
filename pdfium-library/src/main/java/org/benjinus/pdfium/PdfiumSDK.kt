...
class PdfiumSDK(
    ...
    external fun nativeOpenMemDocument(
        data: ByteArray,
        password: String
    ): Long
    ...
    external fun nativeGetPageWidthPixel(
        pagePtr: Long,
        dpi: Int
    ): Int

    external fun nativeGetPageHeightPixel(
        pagePtr: Long,
        dpi: Int
    ): Int
    ...
    external fun nativeGetDocumentMetaText(
        docPtr: Long,
        tag: String
    ): String?

    external fun nativeGetFirstChildBookmark(
        docPtr: Long,
        bookmarkPtr: Long?
    ): Long?

    external fun nativeGetSiblingBookmark(
        docPtr: Long,
        bookmarkPtr: Long
    ): Long?

    external fun nativeGetBookmarkTitle(bookmarkPtr: Long): String?
    external fun nativeGetBookmarkDestIndex(
        docPtr: Long,
        bookmarkPtr: Long
    ): Long

    external fun nativeGetPageSizeByIndex(
        docPtr: Long,
        pageIndex: Int,
        dpi: Int
    ): Size
    ...
    external fun nativeGetDestPageIndex(
        docPtr: Long,
        linkPtr: Long
    ): Int?

    external fun nativeGetLinkURI(
        docPtr: Long,
        linkPtr: Long
    ): String?
    ...
    external fun nativeLoadTextPages(
        docPtr: Long,
        fromIndex: Int,
        toIndex: Int
    ): LongArray
    ...
    external fun nativeTextGetUnicode(
        textPagePtr: Long,
        index: Int
    ): Int

    external fun nativeTextGetCharBox(
        textPagePtr: Long,
        index: Int
    ): DoubleArray
    ...
    ///////////
    fun onAnnotationAdded(
        pageIndex: Int,
        pageNewPtr: Long
    ) {
    }

    fun onAnnotationUpdated(
        pageIndex: Int,
        pageNewPtr: Long
    ) {
    }
    ...
    fun openPage(pageIndex: Int): Long {
        val pagePtr: Long = nativeLoadPage(
            mNativeDocPtr,
            pageIndex
        )
    ...
    fun openPage(
        ...
        val pagesPtr: LongArray = nativeLoadPages(
            mNativeDocPtr,
            fromIndex,
            toIndex
        )
    ...
    fun renderPage(
        ...
        try {
            ...
            Log.e(
                TAG,
                "mContext may be null"
            )
            e.printStackTrace()
        } catch (e: Exception) {
            Log.e(
                TAG,
                "Exception throw from native"
            )
            e.printStackTrace()
        }
    }
    ...
    val bookmarks: List<Bookmark>
        get() {
            ...
            val first = nativeGetFirstChildBookmark(
                mNativeDocPtr,
                null
            )
            first?.let {
    ...
    private fun recursiveGetBookmark(
        ...
        bookmark.pageIdx = nativeGetBookmarkDestIndex(
            mNativeDocPtr,
            bookmarkPtr
        )
        tree.add(bookmark)
        val child = nativeGetFirstChildBookmark(
            mNativeDocPtr,
            bookmarkPtr
        )
        if (child != null) {
        ...
        val sibling = nativeGetSiblingBookmark(
            mNativeDocPtr,
            bookmarkPtr
        )
        sibling?.let {
    ...
    fun prepareTextInfo(
        ...
        val textPagesPtr: LongArray = nativeLoadTextPages(
            mNativeDocPtr,
            fromIndex,
            toIndex
        )

...
class CacheManager {
    ...
    public boolean upPartIfContained(int page, RectF pageRelativeBounds, int toOrder, String searchQuery) {
        PagePart fakePart = new PagePart(page, null, pageRelativeBounds, false, 0, searchQuery);
     ...
     */
    public boolean containsThumbnail(int page, RectF pageRelativeBounds, String searchQuery) {
        PagePart fakePart = new PagePart(page, null, pageRelativeBounds, true, 0, searchQuery);
        synchronized (thumbnails) {

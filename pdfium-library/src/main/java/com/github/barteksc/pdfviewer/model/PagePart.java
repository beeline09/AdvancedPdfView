...
public class PagePart {
    ...
    public PagePart(int page, Bitmap renderedBitmap, RectF pageRelativeBounds, boolean thumbnail, int cacheOrder, String searchQuery) {
        super();
        this.page = page;
    ...
    public boolean equals(Object obj) {
        ...
        return part.getPage() == page
                && part.searchQuery.equalsIgnoreCase(searchQuery)
